...
- `style`: A dictionary with style definitions. See [Basic styling](?path=/story/examples--basic-styling) and [Rule-based styling](?path=/story/examples--rule-based-styling) for examples.
